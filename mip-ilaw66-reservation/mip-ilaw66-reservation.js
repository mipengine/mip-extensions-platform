/**
 * @file mip-ilaw66-reservation 组件
 * @author
 */
...
+ '-' + fix((newDate.getMonth() + 1), 2)
+ '-' + fix(newDate.getDate(), 2)
+ 'T' + fix(newDate.getHours(), 2)
+ ':' + fix(newDate.getMinutes(), 2);
        ...
        $el.find('.reservationbtn').click(function () {
            ...
            now.setFullYear(parseInt(x.substring(0, 4), 16));
            now.setMonth(parseInt(x.substring(5, 7), 16) - 1);
            now.setDate(parseInt(x.substring(8, 10), 16));
            now.setHours(parseInt(x.substring(11, 13), 16));
            now.setMinutes(parseInt(x.substring(14, 16), 16));
