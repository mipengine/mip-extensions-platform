...
define(function (require) {
    ...
    function onScroll(viewport) {
        ...
        var scrollThresholdClassNames = this.scrollThresholdClassNames;
        ...
        if (-offsetTop >= scrollThreshold) {
            ...
            container.className = container.className.replace(scrollThresholdClassNames, '');
        }
    ...
    customElement.prototype.build = function () {
        ...
        self.scrollThreshold = element.getAttribute('scrollThreshold') || YOFFSET;
        self.scrollThresholdClassNames = ' ' + element.getAttribute('scrollThresholdClassNames') || '';
