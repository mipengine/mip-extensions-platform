/**
 * @file mip-ilaw66xzh-noresponse2 组件
 * @author
 */
...
define(function (require) {
    ...
    customElement.prototype.firstInviewCallback = function () {
        ...
        $(function () {
            ...
            //                      else {
            //                          if (lawyerId) {
            //                              window.top.location.href = 'mipilaw66xzh_request?data=' + data + '&questionType='
            ...
            /*$el.find('#js-textConsulting').click(function () {
                window.top.location.href = 'https://m.baidu.com/zhuanjia/question#/submit?vn=law&ref=alaqiang&ssid=0
                &from=0&uid=0&pu=csrc%40app_secr_txt,sz%401320_2001,ta%40iphone_1_11.2_22_2.8,usm%406
                &bd_page_type=1&baiduid=F90644066BC91C4E0285A23EFBBC5CC9&tj=2gs_2_0_10_l1&htrackid=6ec1913b5246ead3b67a15bc5d256a75';
            });*/
            $el.find('#js-textConsulting').click(function () {
                var textbutturl = 'mipilaw66xzh_reservation';
