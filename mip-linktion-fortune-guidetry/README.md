# mip-linktion-fortune-guidetry

mip-linktion-fortune-guidetry ajax表单提交

标题|内容
----|----
类型|通用
支持布局|responsive,fixed-height,fill,container,fixed
所需脚本|https://c.mipcdn.com/static/v1/mip-linktion-fortune-guidetry/mip-linktion-fortune-guidetry.js<br>https://c.mipcdn.com/static/v1/mip-lightbox/mip-lightbox.js


## 示例

```html
<mip-linktion-fortune-guidetry id="try">
      ...
      <div class="modal-content">
        ...
        <form class="modal-body clearfix">
          ...
          <div class="select-checkbox">
            ...
            <div class="form-group">
              <input type="checkbox" name="myinfo" value="保险规划" id="card_insurance" required="required"><label for="card_insurance">保险规划</label>
            </div>
            <div class="form-group">
              <input type="checkbox" name="myinfo" value="投资" id="card_invest" required="required"><label for="card_invest">投资</label>
            </div>
            <div class="form-group">
              <input type="checkbox" name="myinfo" value="贷款" id="card_loans" required="required"><label for="card_loans">贷款</label>
            </div>
          </div>
