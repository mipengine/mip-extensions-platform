# mip-chuangyejia-infinitescroll 无限滚动
...
所需脚本|https://c.mipcdn.com/static/v1/mip-chuangyejia-infinitescroll/mip-chuangyejia-infinitescroll.js<br/> https://c.mipcdn.com/static/v1/mip-mustache/mip-mustache.js
...
- 接口数据返回示例见文档下方[正常数据示例](/examples/mip-extensions/mip-chuangyejia-infinitescroll.html#markdown-doc-%E6%AD%A3%E5%B8%B8%E6%95%B0%E6%8D%AE%E7%A4%BA%E4%BE%8B)。

```html
<mip-chuangyejia-infinitescroll data-src="xxx">
...
</mip-chuangyejia-infinitescroll>
```

### 根据返回值判断请求结束
如果数据量未知，可以填写 rn="[Infinity](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Infinity)"， 加载完所有数据后，服务端返回空数据自动停止请求。接口数据返回示例见文档下方[空数据示例](/examples/mip-extensions/mip-chuangyejia-infinitescroll.html#markdown-doc-%E7%A9%BA%E6%95%B0%E6%8D%AE%E7%A4%BA%E4%BE%8B)。
...
```html
<mip-chuangyejia-infinitescroll data-src="xxx" template="myTemplate">
    <script type="application/json">
    {
        "rn": 40,
        "pn": 1,
