/**
 * @file mip-ilaw66-falv-linking 组件
 * @author
 */
// linking
                    ...
                    success: function (data) {
                        ...
                        if (dataStatus === 3 || dataStatus === 4 || dataStatus === 7) {
                            ...
                            if (dataStatus === 8 || dataStatus === 6 || dataStatus === 10 || dataStatus === 13) {
                                ...
                                if (window.appBridge && window.appBridge.checkAppFeature('CHANGE_WEBVIEW_TITLE')) {
                                    window.appBridge.changeWebviewTitle('咨询结束');
                                }
                ...
                success: function (data) {
                    ...
                    if (id !== '') {
                        ...
                        window.top.location.href = 'mip_informLawyer?data=' + id + '&questionType='
                            ...
                            + '&lawyerId=' + lawyerId + '&PABackJumpFlg=index';
                    }
                    else {
                        if (state === 1 || state === 2) {
                            //  1.律师正在服务中 2.律师已下线
                    ...
                    if (id !== '') {
                        ...
                        if (data.state === 5) {
                            backOr('温馨提示', data.error, '', '去支付', function () {}, function () {
                                window.top.location.href = 'mip_order?requestId=' + timerRequestId
                                    + '&questionType=' + timerQuestionType;
                            });
                        }
