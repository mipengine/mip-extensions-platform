...
+ lawyerId + '&requestId=' + timerRequestId + '&questionType='
+ questionType + '&secondAskFlg=' + data.reCallNoAnswerTimes;
                                } else {
                                    window.top.location.href = 'informLawyer_failed?lawyerId='
+ lawyerId + '&requestId=' + id + '&questionType='
+ questionType + '&secondAskFlg=' + data.reCallNoAnswerTimes;
                                }
                            }
                        } else {
...
+ askingType + '&lawyerId=' + lawyerId;
        ...
        function continueAskNew(lawyerId, questionType, askingType, csrfToken, continueAskPage) {
            $.ajax({
                async: true,
                type: 'POST',
                url: 'continueAskV3?lawyerId='
+ lawyerId + '&questionType='
+ questionType + '&csrf='
...
+ lawyerId + '&PABackJumpFlg=index';
        ...
        //  意外掉线
        $el.find('.type_dropline').on('click',
        function () {
            // 百度统计
        ...
        //  没有电话打进
        $el.find('.type_nocall').on('click',
        function () {
            // 百度统计
            window._hmt && window._hmt.push(['_trackEvent', 'noCall', 'click']);
            window.top.location.href = 'confirmTel?requestId=' + timerRequestId + '&questionType=' + timerQuestionType;
        });
        //  取消
        ...
        function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (id !== '') {
                        window.top.location.href = 'informLawyer?data='
+ id + '&questionType=' + timerQuestionType + '&lawyerId='
+ getQueryString('lawyerId') + '&PABackJumpFlg=linking';
                    } else {
