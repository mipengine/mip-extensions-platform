...
(function (window, document, Math) {
    ...
    IScroll.prototype = {
        ...
        move: function (e) {
            ...
            if (this.options.momentum && duration < 300) {
                ...
                momentumX = this.hasHorizontalScroll ? topT : {destination: newX, duration: 0};
                ...
                momentumY = this.hasVerticalScroll ? downt : {destination: newY, duration: 0};
    ...
    function createDefaultScrollbar(direction, interactive, type) {
        ...
        if (type === true) {
            ...
            var styleStr = '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;'
            + 'box-sizing:border-box;position:absolute;'
            + 'background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);border-radius:3px';
