/**
 * @file mip-ilaw66-xzh-request 组件
 * @author
 */
    ...
    customElement.prototype.firstInviewCallback = function () {
        ...
        */
        ...
        function settime() {
            ...
            if (countdown > 60) {
                clearInterval(timer);
                window.top.location.href = 'mipilaw66xzh_lawyer_noresponse?questionType=' + questionType;
            }
            else {
                if (countdown % 5 === 0) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (dataStatus === 2 || dataStatus === 5 || dataStatus === 6
                                ...
                                clearInterval(timer);
                                var url = encodeURI(
                                    'mipilaw66xzh_linking?questionType=' + questionType + '&lawyerName='
                                ...
                                clearInterval(timer);
                                window.top.location.href = 'mipilaw66xzh_lawyer_noresponse?questionType='
                                    + questionType;
                            }
