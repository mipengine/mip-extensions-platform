# mip-cr173-lower
mip-cr173-lower 查找下载地址是否包含违规资源，有则将该应用下架处理。

标题|内容
---|----
类型|通用
支持布局|responsive,fixed-height,fill,container,fixed
所需脚本|https://c.mipcdn.com/extensions/platform/v1/mip-cr173-lower/mip-cr173-lower.js
## 示例
...
<mip-cr173-lower data-shield="cr173">
<title>阿斯顿</title>
    ...
    <header class="info">
        ...
        <div id="downAddress">
            <ul class="m-down-ul f-downbtn-url">
                <li class="m-down-last"><a href="http://tj.tt1386.com/0005/4037" class="span9 m-game-down down f-eject-btn" data-flag="downbtn" id="address">点击下载</a></li>
            </ul>
        </div>
...
```
## 用法
- 用来判断的相关`href`的`ID`必须命名为`address`，
