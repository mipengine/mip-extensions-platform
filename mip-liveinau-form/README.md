...
所需脚本|https://c.mipcdn.com/static/v1/mip-liveinau-form/mip-liveinau-form.js
...
```html
<mip-liveinau-form method="get" url="https://www.mipengine.org?we=123">
...
```html
<mip-liveinau-form method="get" url="https://www.mipengine.org" clear>
...
```html
<mip-liveinau-form method="get" url="https://www.mipengine.org">
     <input type="text" name="customnumber" validatetarget="custom" validatetype="custom" validatereg="^[0-9]*$" placeholder="我是自定义验证规则数字">
     <div class="mip-liveinau-form-target" target="custom">请输入正确的数字</div>
     <input type="submit" value="提交">
 </mip-liveinau-form>
```
...
```html
<mip-liveinau-form method="post" on="submitSuccess:aa.rediret" url="http://localhost:64721/web/Assess.aspx?assessFlag=1" fetch-url="http://localhost:64721/web/Assess.aspx?assessFlag=1">
