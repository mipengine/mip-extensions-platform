# mip-fetch-comment-test

mip-fetch-comment-test 根据点击的年份异步加载酒款的评价信息

标题|内容
----|----
类型|通用
支持布局|container
所需脚本|https://mipcache.bdstatic.com/static/v1/mip-fetch-comment-test/mip-fetch-comment-test.js
