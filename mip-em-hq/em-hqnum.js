...
define(function (require) {
    ...
    module.loadHqData = function loadHqData() {
        ...
        if ($('#wdmxContainer').data('url')) {
            $('#wdmxContainer').html('<img src="' + $('#wdmxContainer').data('url') + '&r=' + Math.random() + '">');
        }
    };
    module.intital = function (stockcode) {
        ...
        hqpic = hqpic + stockid;
        hqpic = hqpic + '&token=894050c76af8597a853f5b408b759f5d&imageType=r&' + Math.random();
        $('#wdmxContainer').html('<img src="' + hqpic + '">');
        setInterval(module.loadHqData, 10000);
    };
    return module;
});
