# mip-ilaw66-baidutwo-order

mip-ilaw66-baidutwo-order 组件说明
法率网订单详情2期
标题|内容
----|----
类型|通用
...
所需脚本|https://c.mipcdn.com/static/v1/mip-ilaw66-baidutwo-order/mip-ilaw66-baidutwo-order.js
...
<mip-sina-rem>
			...
			<mip-ilaw66-baidutwo-order>
				...
				<div class="header_block baidu">
                    ...
                    <a data-type="mip" data-title="订单列表"
                       href="http://cp01-ps-fe-2.epc.baidu.com:8003/sf?pd=law&openapi=1&from_sf=1&ms=1&wd=%E4%B8%AA%E4%BA%BA%E4%B8%AD%E5%BF%83&title=%E4%B8%AA%E4%BA%BA%E4%B8%AD%E5%BF%83&atn=list&vn=law&resource_id=5184">
                        <span  class="glyphicon glyphicon-menu-left pull-left headerlf5back"></span>
                    </a>
                    <div class="header_title">订单详情</div>
					<!--<a data-type="mip" data-title="返回" href="#" class="glyphicon pull-right headerright">
						<mip-img layout="responsive" width="20px" height="20px" src="tempbaidu/images/user.png"></mip-img>
					</a>-->
				</div>
				...
				<div id="toast" >
			        ...
			        <div class="toast">
			            <p class="toast__content">已经被免单</p>
			        </div>
			   </div>
			</mip-ilaw66-baidutwo-order>
		</mip-sina-rem>
