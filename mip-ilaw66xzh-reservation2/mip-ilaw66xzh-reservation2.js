/**
 * @file mip-ilaw66xzh-reservation2 组件
 * @author
 */
    ...
    customElement.prototype.firstInviewCallback = function () {
                ...
                success: function (g) {
                    if (g.RQ && g.RQ.payState === '6') { // 6:欠费时
                        ...
                        $el.find('#link_done').click(function () {
                            var tmpUrl = 'mipilaw66xzh_couponPay?requestId='
                        ...
                        if (g.RV) {
                            ...
                            $el.find('.reservationbtn_change').click(function () { // 修改预约
                                var tmpUrl = 'mipilaw66xzh_reservation'
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.info) {
                        ...
                        $el.find('#link_done').click(function () {
                            var tmpUrl = 'mipilaw66xzh_myreservation';
                            window.top.location.href = tmpUrl;
                        });
                    }
        ...
        function cancelReservation(cancelid) {
            ...
            $el.find('#link_done').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'reservation/cancelRequestReservation?id=' + cancelid + '&_csrf='
                        + $el.find('#_csrf').val(),
                    success: function (g) {
                        console.log(g);
                        if (g.status === 0) {
