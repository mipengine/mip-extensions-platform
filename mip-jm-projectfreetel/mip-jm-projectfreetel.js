...
define(function (require) {
    ...
    customElement.prototype.firstInviewCallback = function () {
        ...
        var cateId = $('mip-jm-projectfreetel').attr('data-phonecateid');
        var articleId = $('mip-jm-projectfreetel').attr('data-phonearticleid');
        var dataUrl = $('mip-jm-projectfreetel').attr('data-phoneurl');
        var dataRemark = $('mip-jm-projectfreetel').attr('data-phoneremark');
