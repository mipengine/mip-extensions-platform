...
define(function (require) {
                ...
                $.ajax({
                    ...
                    success: function (data, status) {
                        if (status = '0' && data !== '') {
                            ...
                            popTelObject.text('');
                            popIdObject.toggle();
                            $('.MIP-shenku-pop-MASK').css('display', 'none');
                            // $('.MIP-shenku-pop-MASK').style.display = 'none';
    ...
    function autoClose() {
            ...
            var seconds = self.element.querySelector('.mip-shenku-pop-seconds');
    ...
    function openMask() {
            ...
            if (!self.maskElement) {
                ...
                mask.id = 'MIP-shenku-pop-MASK';
                mask.className = 'MIP-shenku-pop-MASK';
                mask.setAttribute('on', 'tap:' + self.id + '.close');
                mask.style.display = 'block';

                // 与mip-shenku-pop 同级dom
