...
define(function (require) {
    ...
    BaiduMap.prototype.handleResult = function () {
        ...
        // 电话号码
        var phoneNum = ele.querySelector('#move-out-phone');
        var moveOutAddress = ele.querySelector('#move-out-address');
        ...
        $(moveOutAddress).on('click', function () {
            if (suggest.value === '') {
                ...
                // 详细信息
                var mOutXx = ele.querySelector('#move-out-xx').value;
                // 联系人
                var mOutPerson = ele.querySelector('#move-out-person').value;
                // 联系电话
                var mOutPhone = ele.querySelector('#move-out-phone').value;
                // 搬出搬入数据
    ...
    customElement.prototype.firstInviewCallback = function () {
        ...
        $(addressList).on('click', '.query-list', function () {
            ...
            if (moveAddress === null) {
                ...
                // console.log('非空 使用原数据');
                moveAddress = JSON.parse(moveAddress);
                moveAddress.moveout.location = items;
                localStorage.setItem('moveAddress', JSON.stringify(moveAddress));
            }
        });
    };
