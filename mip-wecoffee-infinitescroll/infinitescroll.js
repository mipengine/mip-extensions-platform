...
define(function (require) {
    ...
    var InfiniteScroll = function (opt) {
        ...
        me.options = $.extend({
            ...
            scrollPageClass: 'mip-wecoffee-infinitescroll-page', // 内容列表每页className
            loadingHtml: '加载中...',
        ...
        init: function () {
            ...
            if (me.options.firstResult.length) {
                me.scrollPageCache.content = me.scrollPageCache.content.concat(
                    me.separatePage(me.options.firstResult)
                );
        ...
        horizontalHack: function () {
            ...
            if (window.orientation !== undefined) {
                ...
                if (window.orientation === 0 || window.orientation === 180) {
                    ...
                    verticalScreenWidth = verticalScreenWidth * $(window).width() / Math.max(
