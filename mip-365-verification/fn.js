/**
 * @file fn Function. Support publiser management
 */
define(function (require) {
    ...
    /**
     * Throttle a function.
     * @param {Function} fn one function
     * @param {number} delay The run time interval
     * @return {Function} this function override
     */
     ...
     */
    function sextend(target, source, deep) {
        for (var key in source) {
            if (deep) {
                ...
                sextend(target[key], source[key], deep);
    ...
    function extend(target) {
        ...
        for (var i = hasDeep ? 2 : 1; i < arguments.length; i++) {
            sextend(target, arguments[i], deep);
        }
        return target;
    }
