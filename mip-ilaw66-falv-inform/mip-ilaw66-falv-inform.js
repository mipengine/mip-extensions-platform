/**
 * @file mip-ilaw66-falv-inform 组件
 * @author
 */
// informLawyer
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (dataStatus === 5 || dataStatus === 6 || dataStatus === 7 || dataStatus
                            ...
                            clearInterval(timer);
                            if (fromRoute) {
                                var url = encodeURI('mip_linking?questionType=' + questionType
                                    + '&lawyerName=' + data.lawyerName + '&requestId='
                                    + id + '&askingType=' + askingType
                            ...
                            === 9 || dataStatus === 10 || dataStatus === 'ERROR' || dataStatus
                            === 'ERROR1' || countdown >= 65) {
                            clearInterval(timer);
                            if (fromRoute) {
                                window.top.location.href = 'mip_informLawyer_failed'
