...
define(function (require) {
    ...
    function autoClose() {
            ...
            var seconds = self.element.querySelector('.mip-hereseo-pop-seconds');
    ...
    function openMask() {
            ...
            if (!self.maskElement) {
                ...
                mask.id = 'MIP-hereseo-pop-MASK';
                mask.className = 'MIP-hereseo-pop-MASK';
                mask.setAttribute('on', 'tap:' + self.id + '.close');
                mask.style.display = 'block';

                // 与mip-hereseo-pop 同级dom
