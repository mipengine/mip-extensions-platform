# mip-ilaw66-falv-raty

mip-ilaw66-falv-raty 组件说明
对律师的服务做评价：可打星（1—5星），并可选择预设的评论选项或自主输入
标题|内容
----|----
类型|通用
支持布局|responsive,fixed-height,fill,container,fixed
所需脚本|https://c.mipcdn.com/static/v1/mip-ilaw66-falv-raty/mip-ilaw66-falv-raty.js
