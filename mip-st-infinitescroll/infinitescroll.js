...
define(function (require) {
    ...
    InfiniteScroll.prototype = {
        ...
        refresh: function () {
            ...
            me.scrollerHeight = this._getScrollerHeight();      // 滚动容器
                ...
                $.when(dataDeferred).then(
                    ...
                    function (newResultArr) {
                        ...
                        if (newResultArr == false || newResultArr === 'NULL') {
                            // hack
                            if (me.scrollPageCache.content.length === 0) {
                                me.options.$result.append(
                                    '<div style="height:' + (me.options.$wrapper.height() - 40) + 'px">'
                                    +   me.options.noMoreDataHtml
                                    + '</div>'
                                );
                            }
                            // 标记数据状态为无数据
