...
define(function (require) {
    ...
    function render() {
        customElement.prototype.firstInviewCallback = function () {
            ...
            $(this.element).find('#' + popButton + '').on('click', function (e) {
                ...
                // 获取数据
                $.ajax({
                    url: 'https://mip.cfjm.cn/mipguestbook.jspx',
                    type: 'POST',
                    async: true,
                    ...
                    success: function (data, status) {
                        if (status = '0' && data !== '') {
                            ...
                            popTelObject.text('');
                            popIdObject.toggle();
                            $('.MIP-cfjm-pop-MASK').css('display', 'none');
                            // $('.MIP-cfjm-pop-MASK').style.display = 'none';
    ...
    function autoClose() {
            ...
            var seconds = self.element.querySelector('.mip-cfjm-pop-seconds');
    ...
    function openMask() {
            ...
            if (!self.maskElement) {
                ...
                mask.id = 'MIP-cfjm-pop-MASK';
                mask.className = 'MIP-cfjm-pop-MASK';
